...
function callData(){
    ...
    //  Area,   Stage,  Time,   Huma,   Ammo,   MRE,    Part,   Doll,   Tool,   Fast,   Repr,   Tokn
	  [1,	1,	15,	15,	40,	0,	0,	0,	0,	0,	0,	0	],
	  [1,	2,	30,	0,	100,	0,	0,	0,	0,	0,	0,	0	],
	  [1,	3,	60,	30,	60,	100,	0,	0,	0,	0,	0,	0	],
	  [1,	4,	45,	140,	0,	0,	0,	0,	0,	0,	0,	0	],
	  [1,	5,	90,	80,	80,	80,	0,	0,	0,	0,	0,	0	],
	  [1,	6,	120,	210,	0,	100,	0,	0,	0,	0,	0,	0	],
	  [1,	7,	150,	0,	120,	300,	0,	0,	0,	0,	0,	0	],
	  [1,	8,	300,	0,	720,	0,	0,	0,	0,	0,	0,	0	],
	  [2,	1,	30,	0,	0,	125,	0,	0,	0,	0,	0,	0	],
	  [2,	2,	40,	90,	50,	45,	0,	0,	0,	0,	0,	0	],
	  [2,	3,	75,	150,	150,	0,	0,	0,	0,	0,	0,	0	],
	  [2,	4,	105,	400,	250,	0,	0,	0,	0,	0,	0,	0	],
	  [2,	5,	150,	105,	265,	110,	0,	0,	0,	0,	0,	0	],
	  [2,	6,	180,	120,	120,	320,	0,	0,	0,	0,	0,	0	],
	  [2,	7,	300,	480,	450,	0,	0,	0,	0,	0,	0,	0	],
	  [2,	8,	420,	0,	0,	1150,	0,	0,	0,	0,	0,	0	],
	  [3,	1,	120,	240,	0,	320,	0,	0,	0,	0,	0,	0	],
	  [3,	2,	90,	100,	200,	135,	0,	0,	0,	0,	0,	0	],
	  [3,	3,	180,	0,	675,	0,	0,	0,	0,	0,	0,	0	],
	  [3,	4,	45,	250,	0,	0,	0,	0,	0,	0,	0,	0	],
	  [3,	5,	60,	0,	0,	300,	0,	0,	0,	0,	0,	0	],
	  [3,	6,	150,	325,	285,	75,	0,	0,	0,	0,	0,	0	],
	  [3,	7,	360,	280,	720,	360,	0,	0,	0,	0,	0,	0	],
	  [3,	8,	480,	150,	1250,	250,	0,	0,	0,	0,	0,	0	],
	  [4,	1,	60,	0,	55,	275,	0,	0,	0,	0,	0,	0	],
	  [4,	2,	165,	240,	360,	240,	0,	0,	0,	0,	0,	0	],
	  [4,	3,	90,	200,	240,	60,	0,	0,	0,	0,	0,	0	],
	  [4,	4,	270,	0,	520,	680,	0,	0,	0,	0,	0,	0	],
	  [4,	5,	120,	240,	100,	300,	0,	0,	0,	0,	0,	0	],
	  [4,	6,	300,	500,	800,	20,	0,	0,	0,	0,	0,	0	],
	  [4,	7,	150,	175,	575,	0,	0,	0,	0,	0,	0,	0	],
	  [4,	8,	720,	500,	690,	1250,	0,	0,	0,	0,	0,	0	],
	  [5,	1,	285,	700,	240,	480,	0,	0,	0,	0,	0,	0	],
	  [5,	2,	45,	0,	0,	250,	0,	0,	0,	0,	0,	0	],
	  [5,	3,	330,	200,	480,	840,	0,	0,	0,	0,	0,	0	],
	  [5,	4,	180,	550,	0,	450,	0,	0,	0,	0,	0,	0	],
	  [5,	5,	90,	0,	525,	0,	0,	0,	0,	0,	0,	0	],
	  [5,	6,	150,	240,	240,	420,	0,	0,	0,	0,	0,	0	],
	  [5,	7,	240,	160,	240,	680,	0,	0,	0,	0,	0,	0	],
	  [5,	8,	540,	1200,	0,	1000,	0,	0,	0,	0,	0,	0	],
	  [6,	1,	120,	0,	360,	375,	0,	0,	0,	0,	0,	0	],
	  [6,	2,	60,	200,	135,	50,	0,	0,	0,	0,	0,	0	],
	  [6,	3,	300,	300,	600,	900,	0,	0,	0,	0,	0,	0	],
	  [6,	4,	270,	600,	800,	0,	0,	0,	0,	0,	0,	0	],
	  [6,	5,	30,	200,	0,	0,	0,	0,	0,	0,	0,	0	],
	  [6,	6,	270,	300,	475,	625,	0,	0,	0,	0,	0,	0	],
	  [6,	7,	600,	800,	800,	800,	0,	0,	0,	0,	0,	0	],
	  [6,	8,	960,	3600,	0,	0,	0,	0,	0,	0,	0,	0	],
	  [7,	1,	600,	800,	800,	800,	0,	0,	0,	0,	0,	0	],
	  [8,	1,	600,	800,	800,	800,	0,	0,	0,	0,	0,	0	],
	  [9,	1,	600,	800,	800,	800,	0,	0,	0,	0,	0,	0	],  
	  [10,	1,	600,	800,	800,	800,	0,	0,	0,	0,	0,	0	],
	  [11,	1,	600,	800,	800,	800,	0,	0,	0,	0,	0,	0	],
	  [0,	1,	600,	800,	800,	800,	0,	0,	0,	0,	0,	0	]
    ];
